...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        """
        Read data from MongoDB and convert it into DataFrame
        """
        try:
    ...
    def export_data_into_feature_store(self, dataframe: pd.DataFrame):
        """
        Save's the dataframe into feature store 
        """
        try:
    ...
    def split_data_into_train_test_split(self, dataframe: pd.DataFrame):
        """
        Perform Train and test split on the dataframe
        """
        try:
            ...
            logging.info("Exited split_data_into_train_test_split method of DataIngestion Class")
    ...
    def initiate_data_ingestion(self):
        """
        Perform data ingestion and store it in feature store 
        """
        try:
